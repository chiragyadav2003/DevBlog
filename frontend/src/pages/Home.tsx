    ...
    <div className="leading-normal tracking-normal text-gray-900 font-sans   ">
            ...
            <div className="flex w-1/2 justify-end content-center ">
              <section className="flex justify-center items-center mx-4">
                <button
                  onClick={() =>
                    window.location.replace(
                      'https://github.com/chiragyadav2003'
                    )
                  }
                ...
                >
                  ...
                  <span className="absolute opacity-0 group-hover:opacity-100 group-hover:text-gray-700 group-hover:text-sm group-hover:-translate-y-10 duration-500">
                    GitHub
                  </span>
                </button>
              </section>
          ...
          <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col items-center">
            ...
            <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
              ...
              <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">
                Unleash creativity, ignite conversations. Join us in a world
            ...
            <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start"></div>
          </div>
        </div>
      </div>
      <footer className="fixed bottom-0 w-full flex justify-stretch items-center bg-white shadow-md pb-6">
        ...
        <div className="flex items-center w-full text-sm  fade-in text-gray-500 no-underline ">
          Made with&nbsp;
          <svg
            className="hover:scale-150 hover:duration-200"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <button
            onClick={() =>
              window.location.replace('https://github.com/chiragyadav2003')
            }
